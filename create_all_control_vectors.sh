...
# ./create_all_control_vectors.sh "0,1" "./c4ai-command-r-plus" "command-r-plus:104b-" 12288 4 16


# Check if we have the correct number of arguments
if [ "$#" -ne 6 ]; then
    echo "Usage: $0 <cuda_devices> <model_id> <output_prefix> <num_prompt_samples> <quantization_bits> <batch_size>"
    echo "Example: $0 \"0,1\" \"/path/to/model\" \"model-prefix-\" 12345 4 16"
    exit 1
fi
